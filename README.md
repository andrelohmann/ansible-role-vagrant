...
![Last test](https://github.com/andrelohmann/ansible-role-vagrant/actions/workflows/test.yml/badge.svg)

## Content

Use this role to provision vagrant
...
The default variable will istall the latest vagrant version, but you can set explicit version numbers

    vagrant_version: 2.4.0 # defaults to 'latest'
